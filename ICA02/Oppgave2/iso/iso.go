...
"\x22\x53\x61\x6C\x75\x74\x2C\x20\xC7\x61\x20\x76\x61\x20\xB0\x2D\x29\x20\xC7\x61\x20\x63\x6F\x75\x74\x65\x20\x80\x35\x30\x22\n\x22\x53\x61\x6C\x75\x74\x2C\x20\xC7\x61\x20\x76\x61\x20\xB0\x2D\x29\x20"+
"\x39A\x3BF\x39a\x3C3\x3C4\x3AF\x3B6\x3B5\x3B9\x20\x80\x35\x30\x22"
...
func GreetingExtendedASCII() {
	...
	for i := 0; i < len(GreetingExtended); i++ {
		greetingext = append(greetingext, byte(i))
		fmt.Printf("%c", GreetingExtended[i])
